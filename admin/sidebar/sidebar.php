...
<body>
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="https://www.stockupworld.in/"><span>StockUpWorld </span></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu" >
			...
			<li ><a href="course_details.php"><em class="fa fa-book">&nbsp;</em> Course Details</a></li>
		...
		<!--	<li ><a href="https://stockupworld.in/courses/Dominus_of_market/index.php" ><em class="fa fa-book">&nbsp;</em>Go to Course</a></li>  -->
